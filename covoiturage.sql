...
--
-- Hôte : localhost
-- Généré le : mar. 12 jan. 2021 à 10:22
...
--
-- Déchargement des données de la table `envoyer_messages`
--

INSERT INTO `envoyer_messages` (`id_Utilisateurs_src`, `id_Utilisateurs_dst`, `contenue`) VALUES
(19, 19, '1942Rj');
...
(7, 'to Marrakech', 100, '12/12/2020', '08:00', 'CASBLANCA', 'Marrakech', 6, 'oui', 19, 1);
...
(13, 'Bougssa Amine', 'Bougssa19@gmail.com', 'rxphu45', '0655434560', 'Marrakech', 1),
(19, 'EL MOUSSAOUI SAID', 'saidelmoussaoui19@gmail.com', 'vdlg4<<<', '0647899999', 'Marrakech', 1);
...
--
ALTER TABLE `offres`
  MODIFY `Id_offer` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
